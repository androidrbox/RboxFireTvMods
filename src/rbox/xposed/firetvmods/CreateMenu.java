...
public class CreateMenu implements IXposedHookZygoteInit, IXposedHookInitPackageResources, IXposedHookLoadPackage
{
        ...
        if (lpparam.packageName.equals("com.amazon.tv.launcher"))
        {
            ...
            XposedHelpers.findAndHookMethod(SettingsItem, "getSettingsItems", Context.class, boolean.class, new XC_MethodHook() {
                ...
                protected void afterHookedMethod(MethodHookParam param) throws Throwable
                {
                    ...
                    settingsItems.add(5, XposedHelpers.newInstance(SettingsItem,
                            5,
                            "Launcher Tweaks",
                            "Select which items should be visible on the launcher.",
                            DRAWABLE_MENU_ITEMS,
